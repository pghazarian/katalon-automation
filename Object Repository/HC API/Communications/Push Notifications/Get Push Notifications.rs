...
<WebServiceRequestEntity>
   ...
   <restUrl>https://hc-dev.saddleback.com/api/internal/promotional-communication-jobs?JobType=${JobType}&amp;AudienceType=${AudienceType}&amp;CategoryIds=${CategoryIds}</restUrl>
