...
<WebServiceRequestEntity>
   ...
   <restUrl>${GlobalVariable.HC_HostUrl}/api/internal/promotional-communication-jobs?AudienceType=${AudienceType}&amp;ChurchEntityId=${ChurchEntityId}&amp;CommunicationCategoryId=${CommunicationCategoryId}&amp;Description=${Description}&amp;Name=${Name}&amp;SendEmail=${SendEmail}</restUrl>
   ...
   <variables>
      <defaultValue>'New Email Notification 1 Description'</defaultValue>
      <description></description>
   ...
   <variables>
      <defaultValue>'New Email Notification 1'</defaultValue>
      <description></description>
