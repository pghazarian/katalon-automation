...
<WebElementEntity>
   <description>To verify the element of Profile Web Avatar photo exists</description>
   <name>Profile Web Avatar - Element</name>
   <tag></tag>
   <elementGuidId>2ba55f8f-b5b5-4ac3-a7e9-09bd49423df3</elementGuidId>
   <selectorCollection>
      <entry>
         <key>BASIC</key>
      </entry>
