...
WebUI.click(findTestObject('HC-Web/Mobile Engagement/Digital Program/Create Digital Program/Digital Program Speaker Dropdown button'))

'Select a speaker from the dropdown'
CustomKeywords.'customUtility.TestObjectHelper.setDPDropDownValueByXPath'('react-select-78--value')
