...
TargetCampus = WebUI.getText(findTestObject('HC-Web/Communications/Segments/Overview/Demographic Info/Segmen Target Campus Value'), 
...
if (TargetCampus != 'N/A') {
    ...
    WebUI.click(findTestObject('HC-Web/Communications/Segments/Overview/Edit Segment Info/Edit Segment Status Radio Button', 
            [('Status') : 'Active']))
    ...
    WebUI.verifyElementVisible(findTestObject('HC-Web/Communications/Segments/Overview/Segment Record Toast'), FailureHandling.OPTIONAL)
    ...
    WebUI.verifyElementText(findTestObject('HC-Web/Communications/Segments/Overview/Segment Status', [('SegmentStatus') : 'Active']), 
        'Active')
