...
WebUI.click(findTestObject('Object Repository/HC-Web/Communications/Segments/Overview/Milestones/Add Milestone/Add Milestone Button'))

'Click on the AND operator'
WebUI.click(findTestObject('HC-Web/Communications/Segments/Overview/Milestones/Add Milestone/Operator', [('index') : 1
            , ('index1') : 1]))
...
'Click on the AND operator'
WebUI.click(findTestObject('HC-Web/Communications/Segments/Overview/Milestones/Add Milestone/Operator', [('index') : 2
            , ('index1') : 1]))
...
'Verify status of selected Milestone is displayed'
WebUI.verifyElementText(findTestObject('HC-Web/Communications/Segments/Overview/Milestones/Milestone Status New Value', 
        [('index') : 2]), '[AND] Complete')

'Verify selected Milestone is displayed'
WebUI.verifyElementText(findTestObject('HC-Web/Communications/Segments/Overview/Milestones/Milestone Label', [('Milestone') : 'Signed Membership Agreement']), 
    'Signed Membership Agreement')
...
WebUI.scrollToElement(findTestObject('HC-Web/Communications/Segments/Overview/Milestones/Add Milestone/Milestones Label'), 
    0)
