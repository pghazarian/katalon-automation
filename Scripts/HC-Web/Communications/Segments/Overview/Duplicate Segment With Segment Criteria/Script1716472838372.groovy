...
'Enter Segment name'
WebUI.setText(findTestObject('HC-Web/Communications/Segments/Create Segment Record/Segment Name Input Field'), SegmentName)
...
WebUI.click(findTestObject('Object Repository/HC-Web/Communications/Segments/Overview/Milestones/Add Milestone/Milestone Status Radio Button'))
