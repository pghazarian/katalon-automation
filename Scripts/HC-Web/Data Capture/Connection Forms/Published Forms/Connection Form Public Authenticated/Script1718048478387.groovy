...
WebUI.waitForElementVisible(findTestObject('Object Repository/HC-Web/Data Capture/Connection Forms/Overview/UnpublishLinkButton'), 
    10)

CustomKeywords.'NavigationHelper.goToHCUrl'(PublicConnectionFormPath)

WebUI.waitForElementPresent(findTestObject('HC-Web/Data Capture/Connection Forms/Overview/Connection Form Public/FirstNameField'), 
    5)

WebUI.delay(1)

FirstName = WebUI.getAttribute(findTestObject('HC-Web/Data Capture/Connection Forms/Overview/Connection Form Public/FirstNameField'), 
    'value')

'Verify the first name field value is not blank'
WebUI.verifyNotEqual(FirstName, '')

LastName = WebUI.getAttribute(findTestObject('HC-Web/Data Capture/Connection Forms/Overview/Connection Form Public/LastNameField'), 
    'value')

'Verify the last name field value is not blank'
WebUI.verifyNotEqual(LastName, '')

Email = WebUI.getAttribute(findTestObject('HC-Web/Data Capture/Connection Forms/Overview/Connection Form Public/EmailField'), 
    'value')
...
WebUI.verifyElementText(findTestObject('Object Repository/HC-Web/Data Capture/Connection Forms/Overview/Connection Form Public/div_Success'), 
    'Success')
...
CustomKeywords.'TestObjectHelper.verifyTextFieldValueEqual'(CustomKeywords.'FormHelper.getTextInputByLabel'(LabelValueSingleLineText), 
    SingleTextValue)

'Verify paragraph text'
CustomKeywords.'TestObjectHelper.verifyTextAreaValueEqual'(CustomKeywords.'FormHelper.getTextAreaByLabel'(LabelValueParagraphText), 
    ParagraphTextValue)

'Verify date text'
CustomKeywords.'TestObjectHelper.verifyTextFieldValueEqual'(CustomKeywords.'FormHelper.getTextInputByLabel'(LabelValueDate), 
    CustomKeywords.'StringHelper.getUSFormatDateForControl'(DateSelected))
...
WebUI.waitForElementPresent(findTestObject('Object Repository/HC-Web/Data Capture/Connection Forms/Overview/Form Details Header'), 
    2)

'Unpublish the form'
WebUI.waitForElementPresent(findTestObject('Object Repository/HC-Web/Data Capture/Connection Forms/Overview/span_Unpublish'), 
    2)

'Check that the form is published'
WebUI.verifyElementText(findTestObject('Object Repository/HC-Web/Data Capture/Connection Forms/Overview/span_Unpublish'), 
    'Unpublish')
