...
if (WebUI.waitForElementVisible(findTestObject('HC-Web/Serving Opps/Roster Page/Member In List', [('memberName') : VolunteerName]), 
    5)) {
    WebUI.click(findTestObject('HC-Web/Serving Opps/Roster Page/Member In List', [('memberName') : VolunteerName]))
    ...
    WebUI.verifyElementNotPresent(findTestObject('HC-Web/Serving Opps/Roster Page/Member In List', [('memberName') : VolunteerName]), 
        10)
}
...
WebUI.waitForElementVisible(findTestObject('HC-Web/Serving Opps/Roster Page/Member In List', [('memberName') : VolunteerName]), 
    10)

WebUI.verifyElementText(findTestObject('HC-Web/Serving Opps/Roster Page/Member In List Scheduled Area', [('memberName') : VolunteerName]), 
    'Scheduled')
