...
try {
    ...
    WebUI.click(findTestObject('HC-Web/Serving Opps/Off Campus Radio Option'))

    'If venue to be created exists, remove it'
    if (WebUI.waitForElementPresent(findTestObject('HC-Web/Serving Opps/Venue List Item Name', [('VenueName') : 'QA Automation Custom Venue']), 
        5)) {
        'Select Venue to be created'
        WebUI.click(findTestObject('HC-Web/Serving Opps/Venue List Item Checkbox', [('VenueName') : 'QA Automation Custom Venue']))

        'Open edit venue drawer'
        WebUI.click(findTestObject('HC-Web/Serving Opps/Venue List Item Name', [('VenueName') : 'QA Automation Custom Venue']))

        'Remove venue'
        WebUI.click(findTestObject('HC-Web/Serving Opps/Off Campus Venue Creation Drawer/Remove Space Button'))

        WebUI.click(findTestObject('HC-Web/Serving Opps/Off Campus Venue Creation Drawer/Remove Space Confirmation Proceed Button'))
    }
    
    'Add new custom venue'
    WebUI.click(findTestObject('HC-Web/Serving Opps/Add Off Campus Venue Button'))

    'Enter Venue Name'
    WebUI.setText(findTestObject('HC-Web/Serving Opps/Off Campus Venue Creation Drawer/Name Text Field'), 'QA Automation Custom Venue')

    'Enter venue address'
    WebUI.setText(findTestObject('HC-Web/Serving Opps/Off Campus Venue Creation Drawer/Address Text Field'), '123 Bug Ave')

    'Enter venue city'
    WebUI.setText(findTestObject('HC-Web/Serving Opps/Off Campus Venue Creation Drawer/City Text Field'), 'Lake Forest')

    'Select venue state'
    CustomKeywords.'TestObjectHelper.setDropDownValue'('off_campus_space_drawer--region', 'California')

    'Enter venue zip code'
    WebUI.setText(findTestObject('HC-Web/Serving Opps/Off Campus Venue Creation Drawer/Zip Code Text Field'), '92690')

    'Enter venue capacity'
    WebUI.setText(findTestObject('HC-Web/Serving Opps/Off Campus Venue Creation Drawer/Capacity Text Field'), '10')

    'Save venue'
    WebUI.click(findTestObject('HC-Web/Serving Opps/Off Campus Venue Creation Drawer/Save Button'), FailureHandling.STOP_ON_FAILURE)
