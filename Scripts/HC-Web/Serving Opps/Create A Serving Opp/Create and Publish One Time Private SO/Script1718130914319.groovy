...
'Select private'
WebUI.click(findTestObject('HC-Web/Serving Opps/Settings Page/Publish Modal/Private Checkbox'))
...
'Verify label confirms so is private'
WebUI.verifyElementText(findTestObject('HC-Web/Serving Opps/Settings Page/Publish Settings Saddleback.com Label'), 'Saddleback.com (private)')
