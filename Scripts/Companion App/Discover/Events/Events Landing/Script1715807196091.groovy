...
'simply enter the enter key - THIS IS A WORK AROUND'
Mobile.tap(Finder.findTextField('Discover/Events/Search'), timeout)
TextField.typeText(Finder.findTextField('Discover/Events/Search'), " " + Keys.ENTER, timeout)
