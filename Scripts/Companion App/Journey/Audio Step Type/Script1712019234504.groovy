...
/*
Prerequiste:  Make sure a Journey is setup with multiple sections and at least one audio step type
...
5. Start the Journey
6. Select the Audio step
7. Verify that Audio start playing automatically
8. Tap on the pause button.
9. Tap on the play button.
10. Scrub the audio backward 
11. Scrub the audio forward
12. Use the 15 second forward button.
13. Use the 15 second backward button.
14. Minimize the CA app
15. Verify that audio continues to play
...
def timeout = 3
def UniqueJourneyName = 'QA Automation Journey - Audio'
