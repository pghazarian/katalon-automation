...
/*
 * 1- Open CA app & Log in
 * 2- Tap on the Gift icon (from the top right corener of the CA homepage)
 * 3- User should link out to Giving page on SB.com, singly signed on with their CA credentials
 * 4- Tap on the logged in user's profile (avatar) icon (top right of page)
 * 5- Select the "View Profile" option 
