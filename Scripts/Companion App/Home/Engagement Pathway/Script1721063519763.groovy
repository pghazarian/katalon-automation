...
Mobile.startApplication('/Users/hagopanush/Downloads/build-1720816465958.apk', true)
...
Mobile.setText(findTestObject('Object Repository/android.widget.EditText'), 'hagopgsb@gmail.com', 0)

Mobile.hideKeyboard()

Mobile.setText(findTestObject('Object Repository/android.widget.EditText (1)'), 'Password@1', 0)
...
Mobile.getText(findTestObject('Object Repository/android.widget.TextView - Welcome back'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.ImageView'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Service Times'), 0)

Mobile.switchToNative()

Mobile.getText(findTestObject('Object Repository/android.widget.TextView - FOLLOWING JESUS'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.TextView - Share Your Story'), 0)
