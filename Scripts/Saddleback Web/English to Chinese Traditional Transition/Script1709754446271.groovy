...
TargetLanguageTranslated = '繁體中文'

LocationTranslated = '分堂'
...
NewToSaddlebackTranslated = '想認識馬鞍峰教會?'

FollowJesusTranslated = '我想跟隨耶穌。'

GetBaptizedTranslated = '我想受浸。'

FindCommunityTranslated = '我想尋找群體。'

StartVolunteeringTranslated = '我想開始做義工。'

MessageHeadingTranslated = '最新消息'

WatchNowTranslated = '現在觀看'
