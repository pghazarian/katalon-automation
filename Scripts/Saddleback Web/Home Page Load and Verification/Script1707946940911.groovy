...
WebUI.verifyElementText(findTestObject('Object Repository/Saddleback Web/Home/Nav/Location Header link'), 
    'Locations')
...
WebUI.verifyElementPresent(findTestObject('Object Repository/Saddleback Web/Home/Latest Message Heading'), 
    0)

'Verify the text for Latest Message is present'
WebUI.verifyElementPresent(findTestObject('Object Repository/Saddleback Web/Home/Latest Message Title'), 
    0)
