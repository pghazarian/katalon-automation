 ...
 * 13. Verify when filtering on a specific Campus, all Service CTAs for selected Campus are displayed
 * 14. Verify when filtering on a specific Service, all Service CTAs for selected Service are displayed
