...
WebUI.verifyElementPresent(findTestObject('Object Repository/HC-Web/Page_Healthy Church/p_EventTitle'), 
    0)

WebUI.verifyElementText(findTestObject('Object Repository/HC-Web/Page_Healthy Church/p_EventTitle'), 
    'HC Test Private Event')
