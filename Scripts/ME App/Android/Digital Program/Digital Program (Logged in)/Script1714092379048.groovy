...
Mobile.tap(findTestObject('Object Repository/ME App/Android/Login/ME Log In or Create an Account (LP Page)'), 
    0)
...
Mobile.tap(findTestObject('Object Repository/Companion App/Android/Buttons/Login/Password Edit Text'), 0)
...
Mobile.tap(findTestObject('Object Repository/ME App/Android/Login/Android Sign In Button'), 0)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/ME App/Android/Digital Program/DP New Start Heading Text'), 
    0)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/ME App/Android/Digital Program/DP Baptism Heading Text'), 
    0)
