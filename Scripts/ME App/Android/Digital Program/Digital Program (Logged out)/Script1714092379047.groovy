...
Mobile.tap(findTestObject('Object Repository/ME App/Android/Login/Campus Selector Continue Button'), 0)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/ME App/Android/Digital Program/DP Check-in Heading Text'), 0)
...
Mobile.verifyElementVisible(findTestObject('Object Repository/ME App/Android/Digital Program/DP New Start Heading Text (1)'), 0)

Mobile.pressBack()

Mobile.tap(findTestObject('ME App/Android/Digital Program/DP Baptism Button'), 0)

Mobile.verifyElementVisible(findTestObject('Object Repository/ME App/Android/Digital Program/DP Baptize Heading Text'), 0)
