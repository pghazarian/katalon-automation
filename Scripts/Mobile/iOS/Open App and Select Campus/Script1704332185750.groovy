...
Mobile.tap(findTestObject('ME App iOS/XCUIElementTypeStaticText - link-label'), 0)

Mobile.tap(findTestObject('Object Repository/ME App iOS/XCUIElementTypeStaticText - item-label (1)'), 0)
